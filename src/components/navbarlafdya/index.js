...
import performances from "../../asstes/performance.svg";
import challenge from "../../asstes/challenge.svg";

import * as N from "./style";

export default function NavbarLafdya() {
  return (
    <N.Container>
